...
$sql_filtrar_mesa ="SELECT idMesas, Numero_mesa, Estado FROM base_bar.mesas where Mesa_Sedes = '$sede' and Estado = '1'";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Gestión de mesas</h1>
                        <?php
                                ...
                                <td>
                                    <center>
                                        <div class="d-grid gap-2">
                                            <form action="gestion_caja.php" method="GET">
