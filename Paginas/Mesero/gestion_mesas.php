...
<head>
    ...
    <title>Mesero - gestion mesas</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                        <form action="Codigo/venta.php" method="POST" class="col-12">
                                    ...
                                    <?php while ($row = mysqli_fetch_array($productos)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="hidden" name="valorProductos[]" value="<?php echo $row["Valor_unidad"]; ?>">
                                                <input type="hidden" name="Cantidad_act[]" value="<?php echo $row["Cantidad_Uni"]; ?>">
                                                <input type="hidden" name="unidad_venta[]" value="<?php echo $total_prod;?>">
                                                <input type="hidden" name="id_venta[]" value="<?php echo $id_venta;?>">
                                                <input type="hidden" name="valor_total[]" value="<?php echo $valor_total; ?>">
                                                <input type="number" name="Cantidad_Uni[]" class="form-control" value="0" placeholder="" min="0">
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
