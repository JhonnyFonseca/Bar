...
$sql_filtrar_mesas = "SELECT idSedes,Nombre, Direccion, Ciudad FROM base_bar.sedes";
$Mesas = mysqli_query($conexion, $sql_filtrar_mesas);
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    <h4>Sedes para gestionar los productos actuales</h4>
                                </div>
                                <div class="card-body">
                                    <table class="table table-striped table-bordered justify-content-center">
                                        ...
                                        <tbody>
                                            <?php while ($row = mysqli_fetch_array($Mesas, MYSQLI_ASSOC)) { ?>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <form action="productos.php" method="GET">
                                                        <input type="hidden" name="idSedes" value="<?php echo $row["idSedes"]; ?>">
                                                        <button type="submit" class="btn btn-success btn-sm editbtn">Gestionar</button>
                                                    </form>
                                                    </td>
                                                </tr>
                                            <?php }
